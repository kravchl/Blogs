...
We have already discussed the dangers of killer robots and omnipotent AI dictators. It may not be clear how we would arrive at either point. Automation is the key to the advancement of the human race. To be able to let a computer figure out a task that could take humans hundreds of years to draw out a conclusion or see a pattern is the obvious choice. The danger is this technology is no longer just limited to outside abuse. We no longer have to just consider a hacker or insider gaining access and wreaking havoc on the world. Now, the system itself is a threat. The algorithms used in the beginning stages a system’s “machine learning” are obviously understood by the programmers. However, when the system has gone through millions of iterations of self-learning, it reacts in ways that the programmers do not understand. In the system that conquered the game of Go, there were times where moves were played that made absolutely no sense to humans but ended in the system successfully winning the game [5]. It’s in this loss of understanding that the danger lies. A machine will perform what it has “learned” to do. If a machine somehow concludes that the easiest way to win a game of Go is to simply kill the opposing player, then there is nothing in the system’s database stopping it from doing so. There are no ethical codes or emotions involved.
There are also dangers in infringing on privacy laws and rights. Attempting to implement the best facial recognition AI software in a public infrastructure can potentially lead to undesired collecting of human behavior and traits [4]. The system could very well perform perfect biometric identification, however the ethics involved in where that data is stored and how it is collected can become unethical if systems aren’t given restrictions. The importance of data collection for analyzing is key in maximizing the potential of AI. However, at what point is the general population going to give up their privacy rights for the sake of advancement. 
## Conclusion
For AI to continue and be implemented in various forms, there needs to be a deep understanding of where the system’s knowledge is headed and how it arrived at that conclusion. Restrictions to the system is key in preventing abuse and infringing on privacy laws and ethical boundaries. We must proceed with caution and gain create a foundation of trust that allows for the data collection necessary to catapult humankind into the future.
